...
import { LoginSubMenu } from "http://envy-server.homenet.telecomitalia.it/loginSubMenu.mjs";
import { SubscribeSubMenu } from "http://envy-server.homenet.telecomitalia.it/subscribeSubMenu.mjs";
...
const menuScript = new IndexScript("//envy-server.homenet.telecomitalia.it/", 500, 600);
